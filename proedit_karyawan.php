...
//proses hapus gambar
      ...
      $sql_f = "UPDATE user set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel', foto ='$fotobaru' WHERE id_karyawan='$id_karyawan'";
